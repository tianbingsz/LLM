# -*- coding: utf-8 -*-
"""sft_train_from_scratch_lora.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1hR6JsUddHQadoa0slQTO9RurrkVZwctm
...
def forward(model, input_ids, labels, attention_mask=None):
    """
        input_ids: (B, T)
        attention_mask: (B, T)
        labels: (B, T)
...
def micro_training_step(model, gradient_accumulation_steps, input_ids, labels, attention_mask=None):
    """
...
# This merges LoRA into the base model
model = model.merge_and_unload()

model.eval()

prompt = "In a future world where AI and humans coexist,"
